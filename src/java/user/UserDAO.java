...
public class UserDAO {
    ...
    private static final String TOP1= "SELECT TOP 1 userID, fullName, roleID from tblUsers";
    ...
    public UserDTO getTop1() throws SQLException {
    UserDTO topUser = null;
    Connection conn = null;
    PreparedStatement ptm = null;
    ResultSet rs = null;
    try {
        ...
        if (rs.next()) {
            ...
            String fullName = rs.getString("fullName");
            String roleID = rs.getString("roleID");
            topUser = new UserDTO(userID, fullName, roleID, "*****");
        }
    } catch (Exception e) {
        e.printStackTrace();
    } finally {
